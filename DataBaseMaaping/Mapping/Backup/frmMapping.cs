...
namespace Camlibel.Mapping
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.txtnameSpace.Text = "Camlibel";
			// 
			// groupBox1
			// 
			...
			// treeTables
			// 
			this.treeTables.Anchor = (((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) 
				| System.Windows.Forms.AnchorStyles.Left) 
				| System.Windows.Forms.AnchorStyles.Right);
			this.treeTables.ImageIndex = -1;
			this.treeTables.Location = new System.Drawing.Point(8, 8);
			this.treeTables.Name = "treeTables";
			this.treeTables.SelectedImageIndex = -1;
			this.treeTables.Size = new System.Drawing.Size(176, 344);
			...
			this.btnGenerate.Text = "Generate C# Class File(s)";
			...
			// txtLocation
			// 
			this.txtLocation.Location = new System.Drawing.Point(376, 160);
			this.txtLocation.Name = "txtLocation";
			this.txtLocation.TabIndex = 12;
			this.txtLocation.Text = "c:\\temp2\\";
			// 
			// Form1
			// 
...
//			ma.CreateCs(ma.GetFields("Assets"),"Camlibel.HelpDesk","Assets");
	//		dataGrid1.SetDataBinding(ma.GetDataSet(),"database");
		...
		private void btnGenerate_Click(object sender, System.EventArgs e)
		{
			...
			{
				map.CreateCs(txtLocation.Text,map.GetFields(tn.Text),txtnameSpace.Text,tn.Text);
				Count++;
			}
			MessageBox.Show("There are "+Count+" C# Class generated");
