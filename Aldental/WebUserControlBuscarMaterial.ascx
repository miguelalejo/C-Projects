<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebUserControlBuscarMaterial.ascx.cs" Inherits="Aldental.WebUserControlBuscarMaterial" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<table style="width: 100%; height: 91px;">
                    <tr>
                        <td class="style27">
                            <dxnb:ASPxNavBar ID="ASPxNavBar1" runat="server" 
                                ...
                                <Groups>
                                    <dxnb:NavBarGroup Text="Material">
                                        <Items>
                                            <dxnb:NavBarItem NavigateUrl="~/WebForm_MaterialProducto.aspx" Text="Añadir">
                                            </dxnb:NavBarItem>
                                        </Items>
                                    </dxnb:NavBarGroup>
                                </Groups>
                ...
                <asp:Image ID="Image1" runat="server" Height="96px" 
                    ...
                    <tr>
                        ...
                        <td class="style23">
                            <asp:DropDownList ID="DropDownListMaterial" runat="server" Height="19px" 
                                Width="111px">
...
<dxp:PanelContent runat="server">
    <dxe:ASPxLabel ID="ASPxLabel1" runat="server">
                ...
                <dxwgv:ASPxGridView ID="ASPxGridViewMaterialProducto" runat="server" 
                    ...
                    <Columns>
                        ...
                        <dxwgv:GridViewDataTextColumn Caption="Código" FieldName="idMaterial" 
                            VisibleIndex="1">
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="Nombre" FieldName="NombreMaterial" 
                            VisibleIndex="2">
                        </dxwgv:GridViewDataTextColumn>
                    </Columns>
