<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebUserControlImpuesto.ascx.cs" Inherits="Aldental.WebUserControlImpuesto" %>
        ...
        <tr>
            ...
            <td align="center" class="style81">
                ...
                <asp:Image ID="Image1" runat="server" Height="124px" 
                    ImageUrl="~/images/impuesto1.jpg" Width="175px" />
                        </td>
                        <td class="style29">
                        </td>
                        <td class="style30">
                    ...
                    ImageUrl="~/images/impuesto2.jpg" Width="163px" />
                        </td>
                        <td class="style62">
                        </td>
                        <td class="style57">
                    ...
                    <tr>
                        ...
                        <td class="style87">
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    <asp:TextBox ID="TextBoxCodimpuesto" runat="server" 
    Height="22px" Width="119px" onkeypress="return validar(event)"></asp:TextBox>
                                </ContentTemplate>
                            </asp:UpdatePanel>
                        </td>
                        <td class="style87">
                    ...
                    <tr>
                            ...
                            <dxnb:ASPxNavBar ID="ASPxNavBar4" runat="server" 
                                ...
                                <groups>
                                    <dxnb:NavBarGroup Text="REPORTE">
                                        ...
                                        <Items>
                                            <dxnb:NavBarItem NavigateUrl="~/WebForm_BuscarImpuesto.aspx" 
                                                Text="Impuesto">
                                            </dxnb:NavBarItem>
                                        </Items>
                                    </dxnb:NavBarGroup>
                        ...
                        <td class="style87">
                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                <ContentTemplate>
                                    <asp:TextBox ID="TextBoxNomImpuesto" runat="server" Height="22px" Width="118px"></asp:TextBox>
                                </ContentTemplate>
                            </asp:UpdatePanel>
                        </td>
                        <td class="style87">
                ...
                <table style="width: 99%; height: 115px;">
                    <tr>
                        ...
                        <td class="style92">
                            ...
                            &nbsp;</td>
                        <td class="style87">
                            Valor del Impuesto</td>
                        <td class="style87">
                                    <asp:TextBox ID="TextBoxValorimpuesto" runat="server" Height="22px" 
                                        Width="122px" onkeypress="return validar(event)"></asp:TextBox>
                        </td>
                        </tr>
                <tr>
    ...
    SeparatorHeight="100%" SeparatorWidth="1px" ShowPopOutImages="True">
        ...
        url="~/App_Themes/BlackGlass/Web/mHorizontalPopOut.png" width="7px" />
                    ...
                    <td class="style98">
                        ...
                        <asp:TextBox ID="TextBoxBuscar" runat="server" Width="98px" Height="22px" onkeypress="return validar(event)"></asp:TextBox>
                    </td>
                </tr>
                <tr>
