<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebUserControlBuscarModeloProducto.ascx.cs" Inherits="Aldental.WebUserControlBuscarModeloProducto" %>
...
<div>
    <table class="style1">
        <tr>
            <td align="center" bgcolor="#336699" class="style5" colspan="4" 
                style="color: #FFFFFF; font-size: large; font-weight: bold">
                BUSCADOR MODELO PRODUCTO</td>
        </tr>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<table style="width: 100%; height: 129px;">
                    <tr>
                        <td class="style27">
                            <dxnb:ASPxNavBar ID="ASPxNavBar1" runat="server" 
                                ...
                                <Groups>
                                    <dxnb:NavBarGroup Text="Modelo">
                                        <Items>
                                            <dxnb:NavBarItem NavigateUrl="~/WebForm_ModeloProducto.aspx" Text="Añadir">
                                            </dxnb:NavBarItem>
                                        </Items>
                                    </dxnb:NavBarGroup>
                                </Groups>
                    ...
                    <tr>
                        ...
                        <td class="style25">
                            <asp:DropDownList ID="DropDownListSelecc" runat="server" Height="23px" 
                                ...
                                <asp:ListItem>Codigo Marca</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                        <td class="style25">
                ...
                <dxwgv:ASPxGridView ID="ASPxGridViewModeloProd" runat="server" 
                    ...
                    <Columns>
                        ...
                        <dxwgv:GridViewDataTextColumn Caption="Código" FieldName="idModelo" 
                            VisibleIndex="1">
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="Nombre" FieldName="NombreModelo" 
                            VisibleIndex="2">
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="Marca" FieldName="marca.NombreMarca" 
                            VisibleIndex="3">
                        </dxwgv:GridViewDataTextColumn>
                    </Columns>
        ...
        <tr>
            ...
            <td align="center" class="style33" colspan="3">
                            <asp:Button ID="ButtonMostrar" runat="server" Height="23px" 
                                ...
                                onclick="ButtonMostrar_Click" BackColor="#E8F8FF" />
            </td>
        </tr>
        <tr>
