<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebUserControl_BuscarMarcaProducto.ascx.cs" Inherits="Aldental.WebUserControl_BuscarMarcaProducto" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<table style="width: 100%; height: 91px;">
                    <tr>
                        <td class="style27">
                            <dxnb:ASPxNavBar ID="ASPxNavBar1" runat="server" 
                                ...
                                <Groups>
                                    <dxnb:NavBarGroup Text="Marca">
                                        <Items>
                                            <dxnb:NavBarItem NavigateUrl="~/WebForm_MarcaProducto.aspx" Text="Añadir">
                                            </dxnb:NavBarItem>
                                        </Items>
                                    </dxnb:NavBarGroup>
                                </Groups>
                ...
                <asp:Image ID="Image1" runat="server" Height="79px" 
                    ...
                    <tr>
                        ...
                        <td class="style23">
                            <asp:DropDownList ID="DropDownListMarca" runat="server" Height="19px" 
                                Width="111px">
                    ...
                    <tr>
                        ...
                        <td class="style23" colspan="3">
                            <dxrp:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" BackColor="#F7F7F7" 
                                Visible="False" Width="200px" onload="ASPxRoundPanel1_Load">
...
<dxp:PanelContent runat="server">
    <dxe:ASPxLabel ID="ASPxLabel1" runat="server">
                ...
                <dxwgv:ASPxGridView ID="ASPxGridViewMarcaProd" runat="server" 
                    ...
                    <Columns>
                        ...
                        <dxwgv:GridViewDataTextColumn Caption="Código" FieldName="idMarca" 
                            VisibleIndex="1">
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="Nombre" FieldName="NombreMarca" 
                            VisibleIndex="2">
                        </dxwgv:GridViewDataTextColumn>
                    </Columns>
