<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebUserControlDescuento.ascx.cs" Inherits="Aldental.WebUserControlDescuento" %>
                    ...
                    <tr>
                        ...
                        <td class="style87">
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    <asp:TextBox ID="TextBoxCoddescuento" runat="server" 
    Height="27px" onkeypress="return validar(event)" Width="124px"></asp:TextBox>
                                </ContentTemplate>
                            </asp:UpdatePanel>
                        </td>
                        <td class="style87">
                    ...
                    <tr>
                            ...
                            <dxnb:ASPxNavBar ID="ASPxNavBar4" runat="server" 
                                ...
                                <groups>
                                    <dxnb:NavBarGroup Text="REPORTE">
                                        ...
                                        <Items>
                                            <dxnb:NavBarItem NavigateUrl="~/WebForm_BuscarDescuento.aspx" 
                                                Text="Descuento">
                                            </dxnb:NavBarItem>
                                        </Items>
                                    </dxnb:NavBarGroup>
                        ...
                        <td class="style87">
                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                <ContentTemplate>
                                    <asp:TextBox ID="TextBoxNomDescuento" runat="server" Height="27px" 
                ...
                <table style="width: 99%; height: 115px;">
                    <tr>
                        ...
                        <td class="style92">
                            ...
                            &nbsp;</td>
                        <td class="style87">
                            Valor del Descuento</td>
                        <td class="style87">
                                    <asp:TextBox ID="TextBoxValorDescuento" runat="server" Height="24px" 
                                        Width="131px" onkeypress="return validar(event)"></asp:TextBox>
                        </td>
                        </tr>
                <tr>
