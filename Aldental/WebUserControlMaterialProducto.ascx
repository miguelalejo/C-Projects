<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebUserControlMaterialProducto.ascx.cs" Inherits="Aldental.WebUserControlMaterialProducto" %>
        ...
        <tr>
            ...
            <td align="center" class="style81">
                ...
                <asp:Image ID="Image1" runat="server" Height="124px" 
                    ImageUrl="~/images/material1.jpg" Width="175px" />
                        </td>
                        <td class="style29">
                        </td>
                        <td class="style30">
                    ...
                    ImageUrl="~/images/material2.jpg" Width="163px" />
                        </td>
                        <td class="style62">
                        </td>
                        <td class="style57">
                    ...
                    <tr>
                        ...
                        <td class="style87">
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    <asp:TextBox ID="TextBoxCodMaterial" runat="server" 
                    ...
                    <tr>
                            ...
                            <dxnb:ASPxNavBar ID="ASPxNavBar4" runat="server" 
                                ...
                                <groups>
                                    <dxnb:NavBarGroup Text="REPORTE">
                                        ...
                                        <Items>
                                            <dxnb:NavBarItem NavigateUrl="~/WebForm_BuscarMaterialProducto.aspx" 
                        ...
                        <td class="style87">
                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                <ContentTemplate>
                                    <asp:TextBox ID="TextBoxNomMaterial" runat="server" Height="20px"></asp:TextBox>
                                </ContentTemplate>
                            </asp:UpdatePanel>
                        </td>
                        <td class="style87">
