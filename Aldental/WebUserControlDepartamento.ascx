<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebUserControlDepartamento.ascx.cs" Inherits="Aldental.WebUserControlBuscarDepartamento" %>
        ...
        <tr>
            ...
            <td align="center" class="style81">
                ...
                <asp:Image ID="Image1" runat="server" Height="124px" 
                    ImageUrl="~/images/cliente.jpeg" Width="175px" />
                        </td>
                        <td class="style29">
                        </td>
                        <td class="style30">
                    ...
                    <tr>
                        ...
                        <td class="style87">
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    <asp:TextBox ID="TextBoxCodDepartamento" runat="server" 
                    ...
                    <tr>
                        ...
                        <td class="style85">
                            <dxnb:ASPxNavBar ID="ASPxNavBar4" runat="server" 
                                ...
                                <groups>
                                    <dxnb:NavBarGroup Text="REPORTE" ItemLinkMode="TextOnly">
                                        <itemimage height="20px" url="~/images/con3.jpeg" width="20px" />
                                        <Items>
                                            <dxnb:NavBarItem NavigateUrl="~/WebForm_BuscarDepartamento.aspx" 
                                                Text="Depatamentos">
                                            </dxnb:NavBarItem>
                                        </Items>
                                    </dxnb:NavBarGroup>
                        ...
                        <td class="style87">
                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                <ContentTemplate>
                                    <asp:TextBox ID="TextBoxNomDepartamento" runat="server" Height="20px"></asp:TextBox>
                                </ContentTemplate>
                            </asp:UpdatePanel>
                        </td>
                        <td class="style87">
