<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebUserControlBuscarDescuento.ascx.cs" Inherits="Aldental.WebUserControlBuscarDescuento" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<table style="width: 100%; height: 91px;">
                    <tr>
                        <td class="style27">
                            <dxnb:ASPxNavBar ID="ASPxNavBar1" runat="server" 
                                ...
                                <Groups>
                                    <dxnb:NavBarGroup Text="Descuento">
                                        <Items>
                                            <dxnb:NavBarItem NavigateUrl="~/WebForm_Descuento.aspx" Text="Añadir">
                                            </dxnb:NavBarItem>
                                        </Items>
                                    </dxnb:NavBarGroup>
                                </Groups>
                ...
                <asp:Image ID="Image1" runat="server" Height="79px" 
                    ...
                    <tr>
                        <td class="style22">
                            <asp:DropDownList ID="DropDownListDescuento" runat="server" Height="19px" 
                                Width="111px">
                                <asp:ListItem Value="codigo">Código</asp:ListItem>
                                <asp:ListItem Value="nombre">Nombre</asp:ListItem>
                                <asp:ListItem>Valor Descuento</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                        <td class="style22">
                ...
                <dxwgv:ASPxGridView ID="ASPxGridViewDescuento" runat="server" 
                    AutoGenerateColumns="False" 
                    style="text-align: center" 
                    CssFilePath="~/App_Themes/BlackGlass/{0}/styles.css" 
                    CssPostfix="BlackGlass" Width="88px">
                    ...
                    <Columns>
                        ...
                        <dxwgv:GridViewDataTextColumn Caption="Código" FieldName="idDescuento" 
                            VisibleIndex="1">
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="Nombre" FieldName="NombreDescuento" 
                            VisibleIndex="2">
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn FieldName="ValorDescuento" 
